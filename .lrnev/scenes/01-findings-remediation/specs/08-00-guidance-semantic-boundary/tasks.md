...
### T-001 建立共享语义常量并同步客户端模板 <!-- lrnev-task: status=pending, created=2026-08-27T07:34:36.168Z, validates=F-01|F-02|D-01 -->
...
### T-002 迁移全局分流与 spec_create 文案 <!-- lrnev-task: status=pending, created=2026-08-27T07:34:36.168Z, depends_on=T-001, validates=F-03|F-04|D-05|D-06 -->
...
### T-003 迁移 Spec 创建后 followup 与重写引导 <!-- lrnev-task: status=pending, created=2026-08-27T07:34:36.168Z, depends_on=T-001, validates=F-05|F-06|D-04 -->
...
### T-004 补齐 GoalAssessor 对称 override 指引 <!-- lrnev-task: status=pending, created=2026-08-27T07:34:36.168Z, depends_on=T-001, validates=F-07|D-07 -->
...
### T-005 完成语义扫描与执行层回归测试 <!-- lrnev-task: status=pending, created=2026-08-27T07:34:36.168Z, depends_on=T-002|T-003|T-004, validates=F-08|F-09|F-10|D-01|D-04 -->
