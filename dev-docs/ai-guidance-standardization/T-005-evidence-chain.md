...
- ✅ 数据模型: Surface interface with surface_id, source, channel, trigger, consumer, content_hash, budget
...
**验收证据**:
- ✅ v2 清单: `guidance-surface-inventory-v2.json` (259 KB, 346 surfaces)
- ✅ v2 清单: `guidance-surface-inventory-v2.md` (199 KB, 人工可读版)
...
| Inventory v2 (JSON) | guidance-surface-inventory-v2.json | 259 KB | ✅ |
| Inventory v2 (MD) | guidance-surface-inventory-v2.md | 199 KB | ✅ |
| 基线报告 | baseline-report.md | 5.7 KB | ✅ |
| 语义审查 | T-003-semantic-review.md | 16 KB | ✅ |
| 违规报告 | semantic-violations-report.md | 13 KB | ✅ |
...
**Inventory v2 (guidance-surface-inventory-v2.json)**:
- Total surfaces: 346
- Channels: governance_doc (76), tool_metadata (84), tool_annotations (42), tool_input_schema (121), ai_followup (5), server_instructions (1), mcp_resource (17)
...
- High-risk findings: 2 contract_tone (低风险，记录不修正)
- Runtime constraints: 0 (验收通过)
- Coverage: 346/346 (100%)
- Budget: 273,270 chars / 68,441 tokens
- Conflicts: 1 (shared trigger in annotations, low severity)
- Duplicates: 0
