...
### 修正文件（第 2 轮）
1. `dev-docs/ai-guidance-standardization/guidance-surface-inventory-v3-runtime.json` (覆盖第 1 轮错误版本)
2. `dev-docs/ai-guidance-standardization/b1-runtime-evidence-manifest.json` (覆盖第 1 轮错误版本)
3. `dev-docs/ai-guidance-standardization/b1-runtime-migration-report.md` (覆盖第 1 轮错误版本)

### 保留文件（未修改）
1. `dev-docs/ai-guidance-standardization/guidance-surface-inventory-v3-08-00.json` (旧 v3, 346 surfaces)
2. `dev-docs/ai-guidance-standardization/b1-evidence-manifest.json` (旧 B1)
3. `dev-docs/ai-guidance-standardization/b0-evidence-manifest.json` (B0-s)
4. `dev-docs/ai-guidance-standardization/b2a-evidence-manifest.json` (B2a)
