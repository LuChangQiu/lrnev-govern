...
📂 Loading inventory: .../guidance-surface-inventory-v2.json
   ✓ Loaded 346 surfaces
...
# Windows (PowerShell):
certutil -hashfile ".\dev-docs\ai-guidance-standardization\guidance-surface-inventory-v2.json" SHA256

# Linux/Mac:
sha256sum ./dev-docs/ai-guidance-standardization/guidance-surface-inventory-v2.json
```
...
| 文件 | 大小 | 状态 |
|------|------|------|
| guidance-surface-inventory-v2.md | 199 KB | ⏳ 待计算 hash |

**验证方法**:
```bash
cd E:\project\.lrnev\lrnev-cli\product\lrnev-govern
# Windows (PowerShell):
certutil -hashfile ".\dev-docs\ai-guidance-standardization\guidance-surface-inventory-v2.md" SHA256

# Linux/Mac:
sha256sum ./dev-docs/ai-guidance-standardization/guidance-surface-inventory-v2.md
```
...
**警告**: `guidance-surface-inventory-v2.json` 不是由扫描器生成，而是由 T-002/T-003 人工修正产生。
